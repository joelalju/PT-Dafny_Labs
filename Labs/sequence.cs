// Dafny program sequence.dfy compiled into C#
...
// Command-line arguments: run --no-verify d:\UU\PT-Dafny_Labs\Labs\sequence.dfy
// sequence.dfy
...
method sequenceGenerate(n: int, n_0: int, n_1: int)
    returns (sequence: array<int>)
  requires n >= 2
  requires n_0 <= n_1
  ensures sequence.Length == n
  ensures sequence[0] == n_0 && sequence[1] == n_1
  ensures n == 2 || forall j: int, _t#0: int, _t#1: int {:trigger sequence[_t#1], sequence[_t#0], sequence[j]} | _t#1 == j - 2 && _t#0 == j - 1 :: 2 <= j && j < n ==> sequence[j] == sequence[_t#0] + sequence[_t#1]
  decreases n, n_0, n_1
{
  ...
  if n == 2 {
    ...
    while i < n
      ...
      invariant forall j: int, _t#0: int, _t#1: int {:trigger sequence_aux[_t#1], sequence_aux[_t#0], sequence_aux[j]} | _t#1 == j - 2 && _t#0 == j - 1 :: 2 <= j && j < i ==> sequence_aux[j] == sequence_aux[_t#0] + sequence_aux[_t#1]
      decreases n - i
    {
...
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _1_n__0;
      BigInteger _2_n__1;
      BigInteger _rhs0 = new BigInteger(10);
      BigInteger _rhs1 = BigInteger.Zero;
      BigInteger _rhs2 = BigInteger.One;
      _0_n = _rhs0;
      _1_n__0 = _rhs1;
      _2_n__1 = _rhs2;
      BigInteger[] _3_fib;
      BigInteger[] _out0;
      _out0 = __default.sequenceGenerate(_0_n, _1_n__0, _2_n__1);
      _3_fib = _out0;
      BigInteger _4_i;
      _4_i = BigInteger.Zero;
      while ((_4_i) < (new BigInteger((_3_fib).Length))) {
        Dafny.Helpers.Print(((_3_fib)[(int)(_4_i)]));
    ...
    public static BigInteger[] sequenceGenerate(BigInteger n, BigInteger n__0, BigInteger n__1)
    {
      BigInteger[] sequence = new BigInteger[0];
      BigInteger[] _0_sequence__aux;
      BigInteger _1_i;
      ...
      _0_sequence__aux = _rhs0;
      _1_i = _rhs1;
      (_0_sequence__aux)[(int)((BigInteger.Zero))] = n__0;
      (_0_sequence__aux)[(int)((BigInteger.One))] = n__1;
      if ((n) == (new BigInteger(2))) {
        sequence = _0_sequence__aux;
        return sequence;
      } else {
        while ((_1_i) < (n)) {
          (_0_sequence__aux)[(int)((_1_i))] = ((_0_sequence__aux)[(int)((_1_i) - (BigInteger.One))]) + ((_0_sequence__aux)[(int)((_1_i) - (new BigInteger(2)))]);
