// Dafny program plateau.dfy compiled into C#
...
// Command-line arguments: run --no-verify d:\UU\PT-Dafny_Labs\Labs\plateau.dfy
// plateau.dfy
...
method checkPlateau(a: array<int>, l: int, u: int)
    returns (b: bool)
  requires 0 <= l < u < a.Length
  ensures (b == true && forall j: int, _t#0: int {:trigger a[_t#0], a[j]} | _t#0 == j + 1 :: l <= j && j < u ==> a[j] == a[_t#0]) || (b == false && exists j: int, _t#0: int {:trigger a[_t#0], a[j]} | _t#0 == j + 1 :: l <= j && j < u && a[j] != a[_t#0])
  decreases a, l, u
{
  var validate, i := true, l;
  while i < u
    invariant l <= i <= u
    invariant validate ==> forall j: int, _t#0: int {:trigger a[_t#0], a[j]} | _t#0 == j + 1 :: l <= j && j < i ==> a[j] == a[_t#0]
    invariant !validate ==> exists j: int, _t#0: int {:trigger a[_t#0], a[j]} | _t#0 == j + 1 :: l <= j && j < i && a[j] != a[_t#0]
    decreases u - i
  {
    if a[i] != a[i + 1] {
      validate := false;
...
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _rhs5 = new BigInteger(3);
      ...
      bool _1_plateau1__2;
      bool _out0;
      _out0 = __default.checkPlateau(_0_a, BigInteger.One, new BigInteger(2));
      _1_plateau1__2 = _out0;
      bool _2_plateau2__5;
      bool _out1;
      _out1 = __default.checkPlateau(_0_a, new BigInteger(2), new BigInteger(5));
      _2_plateau2__5 = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("a[1 .. 2] : ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_plateau1__2));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\na[2 .. 5]: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_plateau2__5));
    }
    public static bool checkPlateau(BigInteger[] a, BigInteger l, BigInteger u)
    {
      bool b = false;
      bool _0_validate;
      BigInteger _1_i;
      ...
      _1_i = _rhs1;
      while ((_1_i) < (u)) {
        if (((a)[(int)(_1_i)]) != ((a)[(int)((_1_i) + (BigInteger.One))])) {
          _0_validate = false;
        }
