// Dafny program assignment2.dfy compiled into C#
...
// Command-line arguments: run --no-verify d:\UU\PT-Dafny_Labs\Examples\assignment2.dfy
// assignment2.dfy

method Exercise1()
{
  var x, y, z: int;
  assume {:axiom} y < x || y == x + 1;
  z := x;
  x := y;
  y := z + 2;
  assert x < y;
...
namespace _module {
  ...
  public partial class __default {
    public static void Exercise1()
    {
      ...
      BigInteger _2_z = BigInteger.Zero;
      _2_z = _0_x;
      _0_x = _1_y;
      _1_y = (_2_z) + (new BigInteger(2));
    }
  }
